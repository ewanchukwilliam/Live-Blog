...
## Plans to remedy? 
Leetcoding! building more applications! and being more focused per project. I'm learning to not start with a stack in mind unless it's necessary. It kind of teaches you bad practices if you try and force something you've never used before to do somehting you thought it would be good for. I've found that more often than not I'm wrong about my usecase and frankenstein my way into a working product I hate. I've learned trying to avoid the footgun is a good way to waste time. Might be good for legacy code practice. but I think for long term systems design practice (the thing I actually want to get into) it would serve me better to think conservatively. 
